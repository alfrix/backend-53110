...
export class productsDAO {
  async getById(_id) {
    try {
      ...
      throw new Error(`Fallo al obtener producto: ${error._message}`);
    }
  }
  ...
  async create(product) {
    try {
      ...
      throw new Error(`Fallo al crear producto: ${error._message}`);
    }
  }
  ...
  async updateOne(_id, product) {
    try {
      ...
      throw new Error(`Fallo al actualizar producto: ${error._message}`);
    }
  }
  ...
  async deleteOne(_id) {
    try {
      ...
      throw new Error(`Fallo al borrar producto : ${error._message}`);
    }
  }
  ...
  async paginate(query, options) {
    try {
      ...
      throw new Error(`Failed to paginate products: ${error._message}`);
    }
  }
}
